...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2021 a las 17:13:39
...
ALTER TABLE `conversacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_474049CFF6F50196` (`participante_id`);
...
ALTER TABLE `participante`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_85BDC5C3A76ED395` (`user_id`);
...
--
ALTER TABLE `conversacion`
  ADD CONSTRAINT `FK_474049CFF6F50196` FOREIGN KEY (`participante_id`) REFERENCES `participante` (`id`);
...
--
ALTER TABLE `participante`
  ADD CONSTRAINT `FK_85BDC5C3A76ED395` FOREIGN KEY (`user_id`) REFERENCES `usuario` (`id`);
